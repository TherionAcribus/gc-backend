...
class GeocachingPersonalNotesClient:
    ...
    def _load_browser_cookies(self) -> None:
        logger.info("Loading browser cookies for Geocaching.com personal notes API...")
        ...
        logger.warning("No browser cookies loaded - personal notes API may fail if authentication is required!")
